...
export declare function until<R>(f4: Fn<void, Promise<Maybe<R>> | Maybe<R>>, f3: Fn<void, Promise<Maybe<R>> | Maybe<R>>, f2: Fn<void, Promise<Maybe<R>> | Maybe<R>>, f1: Fn<void, Promise<R> | R>): Promise<R>;
export declare function until<R>(f3: Fn<void, Promise<Maybe<R>> | Maybe<R>>, f2: Fn<void, Promise<Maybe<R>> | Maybe<R>>, f1: Fn<void, Promise<R> | R>): Promise<R>;
export declare function until<R>(f2: Fn<void, Promise<Maybe<R>> | Maybe<R>>, f1: Fn<void, Promise<R> | R>): Promise<R>;
