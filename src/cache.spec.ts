...
describe("cache", () => {
  describe("cachedFunc", () => {
    test("should cache a function call", () => {
    ...
    test("should cache an array function call", () => {
    ...
    test("should cache promise results function call", async () => {
    ...
    test("should cache promise array function call", async () => {
    ...
    test("should be able to be cleared", () => {
    ...
    test("should be able to have individual keys deleted", () => {
      let testVal = "test response";
